    ...
    <div className="w-[100vw] min-h-[100vh] flex relative">
      ...
      <div className="right_sidebar container p-8 px-12">
        ...
        <div class="w-40 absolute bg-white left-22 h-[86%] overflow-scroll pt-4 px-5 flex flex-col">
          ...
          <Link
            to={'/user/cpp-announcement-page'}
            class="pl-1 mb-3 font-medium hover:underline"
          >
            Announcement
          </Link>
          <Link
            to={'/user/cpp-syllabus-page'}
            class="pl-1 mb-3 font-medium hover:underline"
          >
            Syllabus
          </Link>
          <Link
            to={'/user/cpp-module-page'}
            class="pl-1 mb-3 font-medium hover:underline"
          >
            Module
          </Link>
          <Link
            to={'/user/cpp-quizzes-page'}
            class="pl-1 mb-3 font-medium hover:underline"
          >
            Quiz’s
          </Link>
          <Link
            to={'/user/cpp-grades-page'}
            class="pl-1 mb-3 font-medium hover:underline"
          >
            Grades
          </Link>
        ...
        <div class="p-6 px-6 ms-auto w-[85%]">
          ...
          <p class="text-sm pt-6 text-[#131313]">
            Hi students! Welcome to the site of COS70006 Objected Oriented
            Programming (OOP). My name is Shibli and I will be your unit
            convenor for this unit. On behalf of the teaching team, I would like
            to welcome you to the unit. I hope you'll enjoy the learning
            experience in this unit. We'll be always trying to give you the best
            assistance and instructions. Should you have any questions or
            concerns, please feel free to contact me and/or your tutor. We will
            be more than happy to talk to you and find out the best possible
            solution. The overall aim of this unit is to teach you some basic
            and important OOP concepts and practices. Please make sure that you
            take a look at the Unit Outline which contains the comprehensive
