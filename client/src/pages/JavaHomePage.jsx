      ...
      <div className="right_sidebar container p-8 px-12">
        ...
        <div class="p-6 px-6 ms-auto w-[85%]">
          ...
          <p class="text-sm pt-6 text-[#131313]">
            Hi students! Welcome to the site of COS70006 Java. My name is Shibli
            and I will be your unit convenor for this unit. On behalf of the
            teaching team, I would like to welcome you to the unit. I hope
